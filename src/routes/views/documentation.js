              ...
              <Nav />
                <Row minH="90vh">
                    ...
                    <Col  size={{xs:"12", md:"8", lg:"10"}} bg="gray100">
                       <Row m={{l:{xs:"0%", md:"15%", lg:"30%"}, b:{xs:"20%", md:"15%", lg:"10%"}, r:{xs:"", md:"", lg:"10%"}}}>
                            ...
                            <Div p={"2rem"}rounded="xl" bg="white" m={{t:"2rem"}} d="flex-wrap" h="100vh">
                                ...
                                <Div>
                                    <Text textSize="subheader" w="100%" m={{t:"1rem"}} tag="h1" textAlign="justify">THREE JS <Anchor p=".5rem"><FaExternalLinkAlt /></Anchor></Text>
                                ...
                                <Div >
                                    <Text textSize="subheader" w="100%" m={{t:"1rem"}} tag="h1" textAlign="justify">Atomize <Anchor p=".5rem"><FaExternalLinkAlt /></Anchor></Text>
                                    ...
                                    <Text textSize="subheader" w="100%" m={{t:"1rem", b:"2rem"}} textAlign="justify" tag="h1">React-Icons<Anchor p=".5rem"><FaExternalLinkAlt /></Anchor></Text>
                                    <Text textSize="paragraph" w="100%" m={{t:"1rem", b:"2rem"}} textAlign="justify">Está librería contiene a manera de paquete multiples librerías de íconos que se utilizan dentro de productos como Disney, Amazon y Netflix, en sus interfaces, esto permite una mejor comunicación visual a partir de integrarlos dentro de nuestra UI, estos increíbles íconos funcionan de tal forma que se optimizan según el visualizador en el que sean mostrados, con esto mejora la velocidad de carga esta apliación y evita conflictos de compatibilidad y formato entre navegadores y dispositivos.</Text> 
                                </Div>
                            </Div>
